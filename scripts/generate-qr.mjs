...
const configs = [
  { id: 'itpsis-materials', url: 'https://disk.yandex.ru/d/jfdIENXO7WUADQ', color: '#ED131C' },
  { id: 'lit-main-01', url: 'https://www.iprbookshop.ru/books/156717/details', color: '#4561C8' },
  { id: 'lit-main-02', url: 'https://www.iprbookshop.ru/books/156708/details', color: '#1C8D00' },
]
